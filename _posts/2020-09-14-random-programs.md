...
### Different Algorithms Need Different Generators
...
### Different Algorithms Need Different Seeds
...
### Measure Correctness via Statistics
...
[3] I started thinking about the problem of developing randomized algorithms when I worked at Aventusoft, where we used signal processing algorithms on random inputs. We had code to check the inputs (good), but the program would crash if the check failed (bad). I spent a lot of time mocking out different components and saving inputs to isolate specific performance problems. The guidelines were further refined by experiences during my PhD (where I worked on all sorts of randomized things) and my time at Amazon (where I worked on universal hash functions).
