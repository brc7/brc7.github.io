...
Locality sensitive hashing is a super useful trick. Most people use it for near-neighbor search but is also helpful for sketching algorithms and high-dimensional data analysis. This post will explain four common types of LSH function.
